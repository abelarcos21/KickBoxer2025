            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white text-center">
                        <h4 class="mb-0">Editar Entrenador</h4>
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('entrenador.update', $entrenador) }}"  enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            id="curp"
                                            name="curp"
                                            value="{{ old('curp', $entrenador->curp) }}"
                                            maxlength="18"
                                            required>
                                        @error('curp')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file"
                                            ...
                                            id="imagen"
                                            name="imagen"
                                            value="{{ old('imagen', $entrenador->imagen) }}"
                                            required>
                                        @error('imagen')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('fecha_nacimiento', $entrenador->fecha_nacimiento->format('Y-m-d')) }}"
                                            required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="primer_nombre"
                                            name="primer_nombre"
                                            value="{{ old('primer_nombre', $entrenador->primer_nombre) }}"
                                            required>
                                        @error('primer_nombre')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="segundo_nombre"
                                            name="segundo_nombre"
                                            value="{{ old('segundo_nombre', $entrenador->segundo_nombre) }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('apellido_paterno', $entrenador->apellido_paterno) }}"
                                            required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('apellido_materno', $entrenador->apellido_materno) }}"
                                            required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="nacionalidad"
                                            name="nacionalidad"
                                            value="{{ old('nacionalidad', $entrenador->nacionalidad) }}"
                                            required>
                                        @error('nacionalidad')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            id="domicilio"
                                            name="domicilio"
                                            value="{{ old('domicilio', $entrenador->domicilio) }}"
                                            required>
                                        @error('domicilio')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            id="colonia"
                                            name="colonia"
                                            value="{{ old('colonia', $entrenador->colonia) }}"
                                            required>
                                        @error('colonia')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="municipio"
                                            name="municipio"
                                            value="{{ old('municipio', $entrenador->municipio) }}"
                                            required>
                                        @error('municipio')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="codigo_postal"
                                            name="codigo_postal"
                                            value="{{ old('codigo_postal', $entrenador->codigo_postal) }}"
                                            maxlength="5"
                                            required>
                                        @error('codigo_postal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="estado"
                                            name="estado"
                                            value="{{ old('estado', $entrenador->estado) }}"
                                            required>
                                        @error('estado')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="email"
                                            ...
                                            id="correo"
                                            name="correo"
                                            value="{{ old('correo', $entrenador->correo) }}"
                                            required>
                                        @error('correo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            id="escolaridad"
                                            name="escolaridad"
                                            value="{{ old('escolaridad', $entrenador->escolaridad) }}"
                                            required>
                                        @error('escolaridad')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('grado_kickboxing', $entrenador->grado_kickboxing) }}">

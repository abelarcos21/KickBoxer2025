...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="bi bi-table"></i> Entrenadores Eliminados</h1>
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    @forelse ($entrenadores as $entrenador)
                        ...
                        <tr>
                            ...
                            <td >
                                ...
                                <div class="btn-group">
                                    <a class="btn btn-success btn-sm" href="{{route('entrenador.restore', $entrenador->id)}}"><i class="bi bi-arrow-clockwise fs-5"></i>Restaurar</a>
                                    <a class="btn btn-danger btn-sm" href="{{route('entrenador.forceDelete', $entrenador->id)}}"><i class="bi bi-trash fs-5"></i>Eliminar Permanentemente</a>
                    ...
                    @empty
                        ...
                        <span><h5>No hay Registros Eliminados</h5></span>
